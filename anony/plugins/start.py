...
- تخصصي تشغيل الميوزك في المكالمات الجماعية
...
🆔 المعرف: @{idseno}
لتنصيب بوت كامل ب حقوقك راسل الادارة
...
async def start_private(client, message: Message):
    ...
    await message.reply_photo(
        photo="https://files.catbox.moe/4ptzre.jpg",  # غيّر الرابط لصورتك
